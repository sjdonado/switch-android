...
import com.example.juan.aswitch.R.id.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        drawerToggle = object : ActionBarDrawerToggle(
            ...
            override fun onDrawerOpened(drawerView: View) {
                ...
                if(user.role!!) {
                    navigation.menu.findItem(navigationStories).isVisible = true
...
//                R.id.navigation_dashboard -> {}
                ...
                R.id.navigationStories -> {
                    actionBar.title = getString(R.string.title_fragment_stories)
                    val storiesFragment = EditStoriesFragment.getInstance()
                    fragmentHandler.add(storiesFragment)
                }
